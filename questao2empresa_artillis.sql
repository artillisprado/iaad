...
create table PROGRAMADOR(
	id_programador INT(5) AUTO_INCREMENT = 30001,
	id_startup INT(5) AUTO_INCREMENT = 10001,
...
create table Linguagem_Programação(
	id_linguagem INT(5) PRIMARY KEY AUTO_INCREMENT = 20001,
	nome_linguagem VARCHAR(15) NOT NULL, 
	ano_lançamento YEAR NOT NULL);
create table Startup(
	id_startup INT PRIMARY KEY AUTO_INCREMENT = 10001,
	nome_startup VARCHAR(15) NOT NULL,
	cidade_sede VARCHAR(15) NOT NULL);
create table Programador_Linguagem(
	id_programador INT(5) NOT NULL AUTO_INCREMENT = 30001,
	id_linguagem INT(5) NOT NULL) AUTO_INCREMENT = 20001;
